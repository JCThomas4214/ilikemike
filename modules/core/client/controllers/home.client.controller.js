...
angular.module('core').controller('HomeController', ['$scope', 'Authentication',
  function ($scope, Authentication) {
    ...
    $scope.quotes = [
      {
        text: '"It will be of little avail to the people that the laws are made by men of their own choice if the laws he so voluminous that they connot be read, or so incoherent that they cannot be understood."',
        author: '- James Madison'
      },{
        text: '"A tax cut means higher family income and higher business profits and balanced federal budget. ... As national income grows, the federal government will ultimately end up with more revenues. Prosperity is te real way to balance our budget. By lowering tax rates, by increasing jobs and income, we can expand tax revenues and finally bring our budget into balance."',
        author: '- John F. Kennedy'
      },{
        text: '"The greatest danger to American freedom is a governement the ignores the Constitution."',
